<?php
/**
 * Fifty Festival functions and definitions
 *
 ...
 */
function fifty_festival_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Fifty Festival, use a find and replace
		* to change 'fifty-festival' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'fifty-festival', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'fifty-festival' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'fifty_festival_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'fifty_festival_setup' );
 ...
 */
function fifty_festival_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'fifty_festival_content_width', 640 );
}
add_action( 'after_setup_theme', 'fifty_festival_content_width', 0 );
 ...
 */
function fifty_festival_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'fifty-festival' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'fifty-festival' ),
...
add_action( 'widgets_init', 'fifty_festival_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'fifty_festival_scripts' );
